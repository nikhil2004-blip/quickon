...
.venv\Scripts\pyinstaller --noconfirm --onefile --noconsole --icon app.ico --add-data "client;client" --add-data "server;server" --add-data "assets;assets" --add-data "app.ico;." --name PocketDeck server/server.py
